  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-gradient-to-r from-indigo-900 via-purple-900 to-indigo-900 rounded-xl text-gray-200 shadow-lg">
      ...
      <p className="mb-6 text-lg leading-relaxed text-indigo-100">
        Hello! I’m <span className="font-semibold text-indigo-400">Kristian Ninnis</span>, a passionate web developer with a strong background in building modern, responsive websites using React and Tailwind CSS.
      </p>
      ...
      <p className="mb-6 text-lg leading-relaxed italic text-indigo-200">
        Interested in working together? Feel free to visit my <a href="/contact" className="text-indigo-400 hover:text-indigo-600 hover:underline transition-colors duration-300">Contact</a> page!
      </p>
    </div>
  );
}
